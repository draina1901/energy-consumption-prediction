...
# Assuming the 'time' column is already in datetime format
...
# Assuming "time" column is in POSIXct format
# Assuming "Total_Energy_Consumption" is a numeric column
...
# Assuming your dataset is named 'test_df'
# Assuming 'time' column is already in POSIXct format
